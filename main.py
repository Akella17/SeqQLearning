...
if __name__ == "__main__":
    ...
    # Evaluate untrained policy
    wandb.log({"Eval_Episode_Rewards": eval_policy(policy, env)}, step = 0)
    ...
    for t in range(int(args.max_timesteps)):
        ...
        if done: 
            ...
            log_dict["Episode_Rewards"] = episode_reward
            # Reset environment
            state, done = env.reset(), False
            episode_reward = 0
            episode_timesteps = 0
        ...
        if (t + 1) % args.eval_freq == 0:
            log_dict["Eval_Episode_Rewards"] = eval_policy(policy, env)
